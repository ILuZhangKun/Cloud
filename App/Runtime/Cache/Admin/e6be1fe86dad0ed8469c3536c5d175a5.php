															...
															<div id="actbutton" class="actbuttondiv">
																<div id="mydiv" class="actcontent">
																	...
																	<div class="closebutton">
																		<a href="<?php echo U('active');?>?adnum=<?php echo ($v["adnum"]); ?>&starttime=<?php echo ($v["starttime"]); ?>&endtime=<?php echo ($v["endtime"]); ?>" onclick="submit_Div()">确定</a>
																		<span>　</span>
...
<script src="/cloud/Public/Admin/js/jquery-ui.js"></script>
	...
	<script>
		...
		function submit_Div() {
			...
			alert(time);
//			$("a").attr(document.getElementsByClassName("starttime"),stime);
//			$('a').attr(document.getElementsByClassName("endtime"),etime);
		}
