                ...
                <div class="page-content">
                    <div class="row">
                        <div class="col-xs-12">
                            <!-- PAGE CONTENT BEGINS -->
                            <div class="row">
                                <form action="<?php echo U('adsedit');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="form-item">

                                        <!-- <label class="item-label">广告ID<span class="check-tips"></span></label> -->
                                        <div class="controls">
                                            <input type="hidden" class="text input-mid" name="adnum" value="<?php echo ($list['adnum']); ?>" />
                                        </div>
                                        <label class="item-label">广告名称<span class="check-tips"></span></label>
                                        <!--<div class="controls">-->
                                        <input type="text" class="text input-mid" name="adname" value="<?php echo ($list['adname']); ?>" /><br />
                                        <!--</div>-->
                                        <label class="item-label">开始时间<span class="check-tips"></span></label>
                                        <!--<div class="controls">-->
                                        <input type="date" class="text input-mid" name="starttime" value="<?php echo ($list['starttime']); ?>" />
                                        <!--</div>-->
                                        <label class="item-label">结束时间<span class="check-tips"></span></label>
                                        <!-- <div class="controls">-->
                                        <input type="date" class="text input-mid" name="endtime" value="<?php echo ($list['endtime']); ?>" /><br />
                                        <!--</div>-->
                                        <label class="item-label">广告内容<span class="check-tips"></span></label>
                                        <!--<div class="controls">-->
                                        <!-- <input type="text" class="text input-mid" name="adtext" value="<?php echo ($list['introduction']); ?>"/> -->
                                        <textarea name="adtext" placeholder="这里输入内容" style="width:300px;height:80px; vertical-align: text-top;"><?php echo ($list['adtext']); ?></textarea>
                                        <br />

                                        <!--</div>-->
                                        <label class="item-label">广告备注<span class="check-tips"></span></label>
                                        <!--<div class="controls">-->
                                        <input type="text" class="text input-mid" name="adremark" value="<?php echo ($list['adremark']); ?>" />
                                        <!--</div>-->

                                        <table border="0">
                                            <tr>
                                                <td><label class="item-label">广告图片　<span class="check-tips"></span></label></td>
                                                <td>
                                                    <input type="file" name="test" value="<?php echo ($list['adpic']); ?>" />
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <!--<div class="controls">-->
                                        <input type="text" class="text input-mid" name="adhref" value="<?php echo ($list['adhref']); ?>" />
                                        <!--</div>-->
                                        <label class="item-label">广告标题<span class="check-tips"></span></label>
                                        <!--<div class="controls">-->
                                        <input type="text" class="text input-mid" name="adtitle" value="<?php echo ($list['adtitle']); ?>" /><br />
                                        <!--</div>-->
                                        ...
                                        <!--<div class="controls">-->
                                        <!-- <input type="text" class="text input-mid" name="adtype" value="<?php echo ($list['adtype']); ?>" /> -->
                                        <select id="adtype" name="adtype">


                                            <?php if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if(($list['adtype']) == $v["typename"]): ?><option value="<?php echo ($v["typenum"]); ?>" selected="selected"><?php echo ($v["typename"]); ?></option>
                                                <?php else: ?>
                                                <option value="<?php echo ($v["typenum"]); ?>"><?php echo ($v["typename"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                        <br/>
                                        ...
                                        <!--<div class="controls">-->
                                        <textarea name="introduction" placeholder="这里输入内容" style="width:300px;height:80px;"><?php echo ($list['introduction']); ?></textarea>
                                        <br />

                                        <!--</div>-->
                                        <label class="item-label">最新活动<span class="check-tips"></span></label>
                                        <!-- <div class="controls">-->
                                        <input type="text" class="text input-mid" name="activity" value="<?php echo ($list['activity']); ?>" /><br />
                                        <!--</div>-->
...
<<<<<<< HEAD
                                        <input id="selectedHotelId" style="display:none" value="<?php echo ($list['ad_hotel']); ?>" />
=======
                                        <input id="selectedHotelId" style="display:block" value="<?php echo ($list['ad_hotel']); ?>" />
>>>>>>> 4ca55cbe52cb50d97a834758c67f69e9739becf8

                                        <!--</div>-->
                                        <label class="item-label">电话<span class="check-tips"></span></label>
                                        <!--<div class="controls">-->
                                        <input type="text" class="text input-mid" name="phone" value="<?php echo ($list['phone']); ?>" /><br />
                                        <!-- </div>-->

                                        <label class="item-label">选择播放的位置　<span class="check-tips"></span></label>
                                        <!--<div class="controls">-->
                                        <!--  <input type="radio" name="vehicle" value="0">轮播广告-->
                                        <input type="checkbox" id="vehicle" name="vehicle" value="1">滚动条广告<br />
                                        <!--</div>-->
