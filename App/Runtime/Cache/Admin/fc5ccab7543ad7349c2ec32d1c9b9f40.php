            ...
            <div class="col-xs-12">
              ...
              <form class="form-horizontal" action="<?php echo U('update');?>" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" <?php if($member['uid'] == 1): ?>readonly
                    <?php else: ?> name="user"<?php endif; ?>
                ...
                <div class="form-group">
                  <label class="col-sm-1 control-label no-padding-right" for="form-field-10"> 机构 </label>
                  <div class="col-sm-9">

                    <select id="org_id" name="org_id" class="rcol-xs-10 col-sm-5">
                          <?php if(is_array($org)): $i = 0; $__LIST__ = $org;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val['id']); ?>"
                              <?php if($val['id'] == $member['org_id']): ?>selected="selected"<?php endif; ?>
                              ><?php echo ($val['org_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
...
<script src="/Cloud/Public/Admin/js/jquery-ui.js"></script>
  ...
  <script src="/Cloud/Public/Admin/js/date-time/bootstrap-datepicker.js"></script>
  <script src="/Cloud/Public/Admin/js/function.js"></script>
=======
    window.jQuery || document.write("<script src='/cloud/Public/Admin/js/jquery1x.js'>" + "<" + "/script>");
</script>
<![endif]-->
