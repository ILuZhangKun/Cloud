        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
          ...
          <div class="row">
            <div class="col-xs-12">
              <!-- PAGE CONTENT BEGINS -->
              <div class="cf">
                <a class="btn btn-info" href="<?php echo U('addMenu');?>" value="">新增菜谱</a>
              </div>
              ...
              <table class="table table-striped table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="col-xs-2">所属菜系</th>
                    <th class="col-xs-1">单价</th>
                    <th class="col-xs-1">规格</th>
                    <th class="col-xs-1">推荐菜</th>
                ...
                <tbody>
                  <?php if(is_array($vars)): $i = 0; $__LIST__ = $vars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td align="center"><?php echo ($val['style_name']); ?></td>
                      <td align="center"><?php echo ($val['price']); ?></td>
                      <td align="center"><?php echo ($val['standard']); ?></td>
                      <td>
                        <?php if($val['recommend'] == 1): ?>是
                          <?php else: ?> 否<?php endif; ?>
                      </td>
                      <td align="center"><img src="<?php echo ($val['picture']); ?>" height="50" width="50" /> </td>
                      <td align="center"><?php echo ($val['remark']); ?></td>
                      <td align="center"><a href="<?php echo U('editMenu',array('id'=>$val['id']));?>"><i
                                            class="ace-icon fa fa-pencil bigger-100"></i>修改</a>&nbsp&nbsp;
                        <a href="javascript:;" val="<?php echo U('delMenu',array('id'=>$val['id']));?>" class="dellink"><i
