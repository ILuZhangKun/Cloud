    ...
    <div class="ace-settings-container" id="ace-settings-container">
        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
          ...
          <div class="row">
            <div class="col-xs-12">
              <!-- PAGE CONTENT BEGINS -->
              <form class="form-horizontal" id="form" method="post" action="<?php echo U('editHotel');?>">
                <div class="space-4"></div>
                <div class="form-group">
                    <input type="hidden" name="id" id="name" placeholder="" class="col-xs-10 col-sm-5" value="<?php echo ($val["id"]); ?>">

                  <label class="col-sm-1 control-label no-padding-right" for="form-field-4"> 餐厅名称 </label>
                  <div class="col-sm-9">
                    <input type="text" name="h_name" id="v" placeholder="" class="col-xs-10 col-sm-5" value="<?php echo ($val["h_name"]); ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="h_code" id="v" placeholder="" class="col-xs-10 col-sm-5" value="<?php echo ($val["h_code"]); ?>">
                    <span class="help-inline col-xs-12 col-sm-7">
                        <span class="middle"></span>
                    </span>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
										...
										<select name="h_province" value="<?php echo ($val["h_province"]); ?>"></select>
										<select name="h_city" value="<?php echo ($val["h_city"]); ?>"></select>
										<select name="h_district" value="{val.h_district}"></select><br>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-1 control-label no-padding-right" for="form-field-4"> 详细地址</label>
                  <div class="col-sm-9">
                    <input type="text" name="h_add" id="v" placeholder="" class="col-xs-10 col-sm-5" value="<?php echo ($val["h_add"]); ?>">
                    <span class="help-inline col-xs-12 col-sm-7">
                        <span class="middle"></span>
                    </span>
                  </div>
