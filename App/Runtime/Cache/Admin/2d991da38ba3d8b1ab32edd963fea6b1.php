    ...
    <div class="ace-settings-container" id="ace-settings-container">
        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
          ...
          <div class="row">
            <div class="col-xs-12">
              <!-- PAGE CONTENT BEGINS -->
              <form class="form-horizontal" id="form" method="post" action="<?php echo U('addMenu');?>">
                <div class="form-group">
                  <label class="col-sm-1 control-label no-padding-right" for="form-field-3"> 菜品名称</label>
                  <div class="col-sm-9">
                    <input type="text" name="menu_name" id="name" placeholder="" class="col-xs-10 col-sm-5" value="<?php echo ($var["menu_name"]); ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <select id="style_id" name="style_id" class="rcol-xs-10 col-sm-5">
                          <?php if(is_array($vars)): $i = 0; $__LIST__ = $vars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val['id']); ?>"><?php echo ($val['style_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="price" id="name" placeholder="" class="col-xs-10 col-sm-5" value="<?php echo ($var["price"]); ?>">
                    <span class="help-inline col-xs-12 col-sm-7">
                        <span class="middle"></span>
                    </span>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="standard" id="name" placeholder="" class="col-xs-10 col-sm-5" value="<?php echo ($var["standard"]); ?>">
                    <span class="help-inline col-xs-12 col-sm-7">
                        <span class="middle"></span>
                    </span>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="col-xs-10 col-sm-5"><?php echo UpImage("picture",100,100,$data['picture']);?></div>
                    <span class="help-inline col-xs-12 col-sm-7">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="remark" placeholder="" class="col-xs-10 col-sm-5" value="<?php echo ($var["remark"]); ?>">
                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
                    </span>
                  </div>
