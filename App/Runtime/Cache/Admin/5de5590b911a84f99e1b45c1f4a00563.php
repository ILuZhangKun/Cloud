                ...
                <!-- /section:basics/sidebar.options -->
                    ...
                    <div class="row" >
                        <div class="col-xs-12">
                            <!-- PAGE CONTENT BEGINS -->
                            <div class="row" >
                                <div id="accordion-sysinfo" class="accordion-style1 panel-group col-sm-3" style="width: 1150px;">
                                    <div class="panel panel-default">
                                        <div class="panel-heading" >
                                            <h4 class="panel-title">
                                            <a class="accordion-toggle" data-toggle="collapse"
                                               data-parent="#accordion-sysinfo" href="#sysinfo">必胜客集团分店 &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                                               <input type="button" value="返回" name="" onclick="window.history.back(); ">
                                                ...
                                                <div  id="box1">
                                                    <div style="width: 100%;overflow: scroll;">
                                                        <table style="border: 1px solid gray;margin: 15px;width: 1090px;font-size: 14px;height: 310px;">
                                                            ...
                                                            <?php if(is_array($dishnumbymonth)): foreach($dishnumbymonth as $key=>$v): ?><tr style="background-color: rgb(248,248,248);">
                                                            ...
                                                            <tr>
                                                            <td>销售额</td>
                                                                <td><?php echo ($salebymonth["month1"]); ?></td>
                                                                <td><?php echo ($salebymonth["month2"]); ?></td>
                                                                <td><?php echo ($salebymonth["month3"]); ?></td>
                                                                <td><?php echo ($salebymonth["month4"]); ?></td>
                                                                <td><?php echo ($salebymonth["month5"]); ?></td>
                                                                <td><?php echo ($salebymonth["month6"]); ?></td>
                                                                <td><?php echo ($salebymonth["month7"]); ?></td>
                                                                <td><?php echo ($salebymonth["month8"]); ?></td>
                                                                <td><?php echo ($salebymonth["month9"]); ?></td>
                                                                <td><?php echo ($salebymonth["month10"]); ?></td>
                                                                <td><?php echo ($salebymonth["month11"]); ?></td>
                                                                <td><?php echo ($salebymonth["month12"]); ?></td>
                                                             
                                                            </tr>
                                                        </table>
                                                    </div>
                                                    <div style="width: 100%;height: auto;padding-top: 10px; margin-left: 50px;">
