            ...
            <div class="col-xs-12">
              ...
              <div class="row">
                <form class="form-inline" action="" method="get">
                  <a class="btn btn-info" href="<?php echo U('addHotel');?>" value="">新增餐厅</a>
                  ...
                  <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                          ...
                          <td class="center">
                            <?php echo ($val["org_name"]); ?>
                          </td>
                          <td class="center"><?php echo ($val["h_name"]); ?></td>
                          <td class="center"><?php echo ($val["h_code"]); ?></td>
                          
                          <td class="center"><?php echo ($val["h_province"]); echo ($val["h_city"]); echo ($val["h_district"]); echo ($val["h_add"]); ?></td>
                          <td class="center"><?php echo ($val["h_scode"]); ?></td>

                          <td class="center"><a href="<?php echo U('editHotel',array('id'=>$val['id']));?>">修改</a>&nbsp;
                            <?php if($val['uid'] != 1): ?><a class="del" href="javascript:;" val="<?php echo U('delHotel',array('id'=>$val['id']));?>" title="删除">删除</a><?php endif; ?>
                          </td>
