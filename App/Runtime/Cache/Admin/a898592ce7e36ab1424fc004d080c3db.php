            ...
            <div class="col-xs-12">
              ...
              <form class="form-horizontal" id="form" method="post" action="<?php echo U('add');?>">
                <div class="form-group">
                  <label class="col-sm-1 control-label no-padding-right" for="form-field-3"> 菜系名称</label>
                  <div class="col-sm-9">
                    <input type="text" name="style_name" id="name" placeholder="" class="col-xs-10 col-sm-5" value="<?php echo ($var["style_name"]); ?>">
