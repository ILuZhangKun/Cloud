        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
          ...
          <div class="row">
            <div class="col-xs-12">
              <!-- PAGE CONTENT BEGINS -->
              <div class="cf">
                <a class="btn btn-info" href="<?php echo U('add');?>" value="">新增机构</a>
              </div>
              ...
              <table class="table table-striped table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="col-xs-2">机构名称</th>
                    <th class="col-xs-2">组织机构代码</th>
                    <th class="col-xs-2">法人</th>
                    <th class="col-xs-2">法人身份证号</th>
                    <th class="col-xs-2">操作</th>
                  </tr>
                </thead>
                <tbody>
                  <?php if(is_array($var)): $i = 0; $__LIST__ = $var;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                      <td><?php echo ($i); ?></td>
                      <td><?php echo ($val['org_name']); ?></td>
                      <td><?php echo ($val['org_code']); ?></td>
                      <td><?php echo ($val['org_legal_person']); ?></td>
                      <td><?php echo ($val['org_legal_person_code']); ?></td>
                      <td><a href="<?php echo U('edit',array('id'=>$val['id']));?>"><i
                                            class="ace-icon fa fa-pencil bigger-100"></i>修改</a>&nbsp&nbsp;<a href="javascript:;" val="<?php echo U('delete',array('id'=>$val['id']));?>" class="dellink"><i
