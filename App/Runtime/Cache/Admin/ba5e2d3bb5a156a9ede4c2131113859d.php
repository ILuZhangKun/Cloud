  ...
  <div class="main-container" id="main-container">
    ...
    <div class="main-content">
      <div class="main-content-inner">
        ...
        <!-- PAGE CONTENT BEGINS -->
        <div class="row">
        <form action="<?php echo U('addty');?>" method="post" class="form-horizontal">
            <!-- <div class="form-item"> -->
                <label class="item-label">类别名称<span class="check-tips"></span></label>
               <!--  <div class="controls"> -->
                    <input type="text" class="text input-mid" name="typename" value=""/><br />
                <!-- </div>
            </div> -->
           <label class="item-label">备注<span class="check-tips"></span></label>
           <textarea placeholder="这里输入内容" name="remark" style="width: 300px; height: 100px; vertical-align: text-top;"></textarea><br/>
            <div class="form-item">
