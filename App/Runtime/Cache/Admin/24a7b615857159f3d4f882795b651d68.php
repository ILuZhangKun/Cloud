                  ...
                  <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                          <td class="center">
                            <?php if($val['uid'] != 1): ?><input class="uids" type="checkbox" name="uids[]" value="<?php echo ($val['uid']); ?>">
                              <?php else: ?>
                          ...
                          <td>
                            <?php if($val['gid'] == 1 ): ?>超级管理员
                              <?php else: ?> <?php echo ($val["org_name"]); endif; ?>

                          </td>
                          <td class="center">
                            <?php if($val['sex']==1){echo '男';}elseif($val['sex']==2){echo '女';}else{echo '保密';} ?>
                          </td>
                          ...
                          <td class="center"><a href="<?php echo U('edit',array('uid'=>$val['uid']));?>">修改</a>&nbsp;
                            <?php if($val['uid'] != 1): ?><a class="del" href="javascript:;" val="<?php echo U('del',array('uids'=>$val['uid']));?>" title="删除">删除</a><?php endif; ?>
                          </td>
