        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
          ...
          <div class="row">
            <div class="col-xs-12">
              <!-- PAGE CONTENT BEGINS -->
              <div class="cf">
                <a class="btn btn-info" href="<?php echo U('add');?>" value="">新增菜系</a>
              </div>
              ...
              <table class="table table-striped table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="col-xs-2">菜系名称</th>
                    <th class="col-xs-2">菜品数量</th>
                ...
                <tbody>
                  <?php if(is_array($vars)): $i = 0; $__LIST__ = $vars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td><a href="<?php echo U('edit',array('id'=>$val['id']));?>"><i
                        ...
                        <a href="javascript:;" val="<?php echo U('delStyle',array('id'=>$val['id']));?>" class="dellink"><i
